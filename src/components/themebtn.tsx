  ...
  return (
    ...
    >
      <button
        type="button"
        className={cn(
          "w-[30px] h-[30px] text-gray-500 relative z-10",
          theme === "light" &&
            "  transition-all duration-700  text-gray-300  rounded-full "
        )}
      ...
      <button
        ...
        className={cn(
          ...
          theme === "dark" &&
            " transition-all duration-700  dark:text-gray-100  rounded-full "
        )}

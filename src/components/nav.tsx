...
const Nav = (props: { brandText: string }) => {
  ...
  return (
    <nav className="sticky top-0 z-40 flex flex-row w-screen flex-wrap items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0b14374d] sm:min-h-[70px]">

...
const Profile = () => {
  return (
    <>
      <div className="overflow-hidden h-screen  rounded-sm bg-white shadow-default dark:border-strokedark dark:!bg-navy-800">
        <div className="relative z-20 h-35 md:h-65">
          ...
          <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
            <label
              htmlFor="cover"
              className="flex cursor-pointer items-center justify-center gap-2 rounded bg-navy-800 py-1 px-2 text-sm font-medium text-white hover:bg-opacity-80 xsm:px-4"
            >
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-[50px] h-30 w-full max-w-[100px] rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
          ...
          <div className="mt-4 text-black dark:text-white">
            <h3 className="mb-1.5 text-2xl font-semibold ">Phoenix</h3>
